      ...
      <form className="new">
        ...
        >
          {this.state.templates.map((template, index) => (
            <option key={index} value={template.fullPath}>
              {template.fileName}
            </option>
          ))}
        </select>
        ...
        <input
          ...
          placeholder="Top"
          required
          onChange={e => this.changeTop(e.target.value)}
        />
        ...
        <input
          ...
          placeholder="Bottom"
          required
          onChange={e => this.changeBottom(e.target.value)}
        />

        {this.state.preview && (
          <Meme meme={this.state.preview} update={new Date()} />
        )}
